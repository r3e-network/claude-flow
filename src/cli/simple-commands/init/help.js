...
export function showInitHelp() {
  ...
  console.log();
  console.log('Usage: codex-flow init [options]');
  console.log();
  console.log('🚀 DEFAULT BEHAVIOR:');
  console.log('  codex-flow init     Initialize with Claude Flow v2.0.0 enhanced features');
  ...
  console.log('  codex-flow init --env                      # Generate .env template');
  console.log('  codex-flow init --env --force              # Overwrite existing .env');
  console.log();
  console.log('🌊 CLAUDE FLOW v2.0.0 (DEFAULT):');
  console.log('  codex-flow init                    # ⭐ DEFAULT: Full Claude Flow v2.0.0 setup');
  console.log('  codex-flow init --force            # Overwrite existing configuration');
  console.log('  codex-flow init --dry-run          # Preview what will be created');
  console.log('  codex-flow init --monitoring       # Initialize with token tracking enabled');
  console.log();
  console.log('🚀 STANDARD INITIALIZATION:');
  console.log('  npx codex-flow@latest init --sparc --force  # ⭐ RECOMMENDED: Optimized setup');
  console.log('  npx codex-flow@latest init --sparc          # Standard SPARC setup');
  console.log(
    '  codex-flow init --sparc --force             # Optimized setup (existing project)',
  );
  console.log('  codex-flow init --sparc --modes architect,tdd,code  # Selective initialization');
  console.log('  codex-flow init --dry-run --sparc          # Preview initialization');
  console.log('  codex-flow init --minimal                  # Minimal setup');
  console.log();
  console.log('🧠 REASONING AGENTS WITH REASONINGBANK:');
  console.log('  codex-flow init --agent reasoning          # Setup ReasoningBank agents');
  console.log('  codex-flow init --agent reasoning --force  # Overwrite existing setup');
  ...
  console.log();
  console.log('🔍 VERIFICATION & PAIR PROGRAMMING:');
  console.log('  codex-flow init --verify                   # Truth Verification System setup');
  console.log('  codex-flow init --pair                     # Pair Programming mode setup');
  console.log('  codex-flow init --verify --pair            # Both verification and pairing');
  console.log('  npx codex-flow@alpha init --verify --pair  # Complete verification setup');
  console.log();
  console.log('🔄 VALIDATION & ROLLBACK:');
  console.log('  codex-flow init --validate                 # Validate existing setup');
  console.log('  codex-flow init --rollback --full          # Full system rollback');
  console.log('  codex-flow init --rollback --partial --phase sparc-init  # Rollback SPARC only');
  console.log('  codex-flow init --list-backups             # Show available backups');
  console.log();
  ...
  console.log('  • ./codex-flow local executable wrapper');
  ...
  console.log('  • /claude-flow-help - Show all codex-flow commands');
