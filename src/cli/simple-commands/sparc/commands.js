...
export function showSparcCommandsHelp() {
  ...
  console.log();
  console.log('Usage:');
  console.log('  codex-flow sparc-<command> "<task-description>" [options]');
  console.log();
  console.log('Examples:');
  console.log('  codex-flow sparc-dev "build user authentication system"');
  console.log('  codex-flow sparc-api "create REST API for e-commerce" --swarm');
  console.log('  codex-flow sparc-test "comprehensive testing for payment module"');
  console.log('  codex-flow sparc-security "security audit for web application"');
}
