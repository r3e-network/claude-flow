...
💡 EXAMPLES:
  ...
  codex-flow pair --start --mode driver --verify
  codex-flow pair --start --verify --test
  codex-flow pair --start --agent senior-dev --test
  codex-flow pair --status
  codex-flow pair --end

🎯 QUICK START:
  npx codex-flow@alpha pair --start --verify --test
