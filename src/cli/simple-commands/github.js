...
`);
  ...
  console.log(`
EXAMPLES:
  codex-flow github pr-manager "create feature PR with automated testing"
  ...
  codex-flow github repo-architect "optimize repository structure"
  codex-flow github issue-tracker "analyze project roadmap issues"
  codex-flow github sync-coordinator "sync package versions across repos"
