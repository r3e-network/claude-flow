...
async function runInteractiveWizard() {
  ...
  try {
    ...
    if (result.success) {
      ...
      console.log(chalk.gray('  • View status: codex-flow hive-mind status'));
      console.log(chalk.gray('  • Monitor progress: codex-flow hive-mind metrics'));
      console.log(chalk.gray('  • Create another swarm: codex-flow hive-mind wizard'));
      console.log(chalk.gray('  • Learn more: codex-flow help hive-mind\n'));
    ...
    console.log(chalk.gray('You can try manual setup with: codex-flow hive-mind init'));
  }
}
