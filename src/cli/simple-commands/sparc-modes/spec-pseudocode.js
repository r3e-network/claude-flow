...
1. **Requirements Gathering** (15 mins)
   ...
   - Store requirements: \`npx codex-flow memory store ${memoryNamespace}_requirements "..."\`
...
2. **Specification Writing** (20 mins)
   ...
   - Store specs: \`npx codex-flow memory store ${memoryNamespace}_specifications "..."\`
...
3. **Pseudocode Development** (20 mins)
   ...
   - Map process flows
   - Include TDD anchors
   - Store pseudocode: \`npx codex-flow memory store ${memoryNamespace}_pseudocode "..."\`
