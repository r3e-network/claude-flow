...
1. **Integration Planning** (10 mins)
   ...
   - Plan data mappings
   - Store plan: \`npx codex-flow memory store ${memoryNamespace}_mcp_plan "..."\`
...
2. **Connection Setup** (15 mins)
   ...
   - Store config: \`npx codex-flow memory store ${memoryNamespace}_mcp_config "..."\`
...
3. **Data Integration** (20 mins)
   ...
   - Store integration: \`npx codex-flow memory store ${memoryNamespace}_mcp_integration "..."\`
