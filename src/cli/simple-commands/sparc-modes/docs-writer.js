...
1. **Documentation Planning** (10 mins)
   ...
   - Store plan: \`npx codex-flow memory store ${memoryNamespace}_doc_plan "..."\`
...
2. **Content Creation** (25 mins)
   ...
   - Store progress: \`npx codex-flow memory store ${memoryNamespace}_doc_content "..."\`
...
3. **User Guides** (15 mins)
   ...
   - Store guides: \`npx codex-flow memory store ${memoryNamespace}_user_guides "..."\`
