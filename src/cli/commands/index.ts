...
export function setupCommands(cli: CLI): void {
  ...
  cli.command({
    ...
    action: async (ctx: CommandContext) => {
      try {
        ...
        console.log("2. Run 'npx codex-flow start' to begin the orchestration system");
      ...
      try {
        ...
        switch (subcommand) {
          ...
          case 'health':
            ...
            console.log(`  - codex-flow agent ${subcommand} ${ctx.args.slice(1).join(' ')}`);
          ...
          default: {
            ...
            console.log('');
            console.log('For detailed help, use: codex-flow agent <command> --help');
            break;
          }
        }
      } catch (err) {
  ...
  try {
    ...
    const enhancedStatusAction = async (ctx: CommandContext) => {
      ...
      console.log('For full enhanced functionality, use: codex-flow status [options]');
      console.log(
      ...
      try {
        ...
        if (options.watch) {
          ...
          console.log('Use: codex-flow status --watch');
        }
      } catch (err) {
      ...
      switch (subcommand) {
        case 'start': {
          ...
          try {
            ...
            if (!health.healthy) {
              warning("Orchestrator is not running. Start it first with 'codex-flow start'");
              return;
            }
            ...
            console.log(`📚 Use 'codex-flow mcp tools' to see all available tools`);
          } catch (err) {
        ...
        case 'stop': {
          try {
            ...
            if (!health.healthy) {
              ...
              warning(
                "MCP server runs as part of the orchestrator. Use 'codex-flow stop' to stop the entire system",
              );
            }
          } catch (err) {
            error(`Failed to check MCP server: ${(err as Error).message}`);
        ...
        case 'restart': {
          try {
            warning(
              "MCP server runs as part of the orchestrator. Use 'codex-flow stop' then 'codex-flow start' to restart the entire system",
            );
          } catch (err) {
...
2. **During Execution**:
   ...
   ${ctx.flags.parallel ? '- Spawn agents: `npx codex-flow agent spawn researcher --name "research-agent"`' : ''}
   ${ctx.flags.parallel ? '- Create tasks: `npx codex-flow task create implementation "implement feature X"`' : ''}
...
3. **Best Practices**:
   ...
   ${ctx.flags.research ? '- Store research findings: `npx codex-flow memory store research_findings "data"`' : ''}
...
# Store your findings
Bash("npx codex-flow memory store analysis_results 'Found 3 critical issues...'")

# Check system status
Bash("npx codex-flow status")

# Create and assign tasks (when --parallel is enabled)
Bash("npx codex-flow task create research 'Research authentication methods'")
Bash("npx codex-flow agent spawn researcher --name auth-researcher")
\`\`\`
...
Now, please proceed with the task: ${task}`;
  ...
  try {
    const enhancedMonitorAction = async (ctx: CommandContext) => {
      ...
      console.log('For full enhanced functionality, use: codex-flow monitor [options]');
      console.log(
  ...
  try {
    const enhancedSessionAction = async (ctx: CommandContext) => {
      ...
      console.log('For full enhanced functionality, use: codex-flow session <command> [options]');
      console.log();
      ...
      if (subcommand) {
        console.log();
        console.log(
          `For detailed help on '${subcommand}', use: codex-flow session ${subcommand} --help`,
        );
      }
    };
  ...
  try {
    const enhancedStartAction = async (ctx: CommandContext) => {
      ...
      console.log();
      console.log('For full enhanced functionality, use: codex-flow start [options]');
      console.log(
  ...
  cli.command({
    ...
    action: (ctx: CommandContext) => {
      ...
      if (command === 'claude') {
        ...
        console.log(
          `  ${blue('codex-flow claude spawn')} "implement user authentication" --research --parallel`,
        );
        console.log(
          `  ${blue('codex-flow claude spawn')} "fix payment bug" --tools "View,Edit,Bash" --no-permissions`,
        );
        console.log(`  ${blue('codex-flow claude batch')} workflow.json --dry-run`);
        console.log();
        console.log(
        ...
        console.log('  codex-flow swarm <objective> [options]');
        console.log(
          '  codex-flow swarm-ui <objective> [options]  # Uses blessed UI (avoids TTY issues)',
        );
        console.log();
        ...
        console.log();
        console.log(bold('Examples:'));
        console.log(`  ${blue('codex-flow swarm')} "Build a REST API"`);
        console.log(`  ${blue('codex-flow swarm-ui')} "Build a REST API"  # Avoids TTY issues`);
        console.log(
          `  ${blue('codex-flow swarm')} "Research cloud architecture" --strategy research --research`,
        );
        console.log(
          `  ${blue('codex-flow swarm')} "Migrate app to microservices" --coordinator --review --ui`,
        );
        console.log();
        console.log(bold('TTY Issues?'));
        console.log("If you encounter 'Raw mode is not supported' errors, use:");
        console.log(`  - ${blue('codex-flow swarm-ui')} <objective>  # Recommended`);
        console.log(`  - ${blue('codex-flow swarm')} <objective> --ui`);
        console.log();
        ...
        console.log(bold('Examples:'));
        console.log(
          `  ${blue('codex-flow sparc modes')}                              # List all modes`,
        );
        console.log(
          `  ${blue('codex-flow sparc run code')} "implement user auth"      # Run specific mode`,
        );
        console.log(
          `  ${blue('codex-flow sparc tdd')} "payment processing system"    # Full TDD workflow`,
        );
        console.log(
          `  ${blue('codex-flow sparc workflow')} project-workflow.json     # Custom workflow`,
        );
        console.log();
        console.log(
        ...
        console.log();
        console.log(bold('Usage:'));
        console.log('  codex-flow start [options]');
        console.log();
        console.log(bold('Options:'));
        ...
        console.log();
        console.log(bold('Examples:'));
        console.log(`  ${blue('codex-flow start')}                    # Interactive mode`);
        console.log(`  ${blue('codex-flow start --daemon')}           # Background daemon`);
        console.log(`  ${blue('codex-flow start --ui')}               # Process management UI`);
        console.log(`  ${blue('codex-flow start --health-check')}     # With pre-flight checks`);
        ...
        console.log();
        console.log(bold('Usage:'));
        console.log('  codex-flow status [options]');
        console.log();
        console.log(bold('Options:'));
        ...
        console.log();
        console.log(bold('Examples:'));
        console.log(`  ${blue('codex-flow status')}                   # Basic status`);
        console.log(`  ${blue('codex-flow status --watch')}           # Live updates`);
        console.log(`  ${blue('codex-flow status --detailed')}        # Comprehensive info`);
        console.log(`  ${blue('codex-flow status --component mcp')}   # Specific component`);
        ...
        console.log();
        console.log(bold('Usage:'));
        console.log('  codex-flow monitor [options]');
        console.log();
        console.log(bold('Options:'));
        ...
        console.log();
        console.log(bold('Examples:'));
        console.log(`  ${blue('codex-flow monitor')}                  # Basic monitoring`);
        console.log(`  ${blue('codex-flow monitor --alerts')}         # With alerting`);
        console.log(`  ${blue('codex-flow monitor --focus mcp')}      # Component focus`);
        console.log(`  ${blue('codex-flow monitor --export data.json')} # Data export`);
        ...
        console.log();
        console.log(bold('Examples:'));
        console.log(`  ${blue('codex-flow session list')}             # List sessions`);
        console.log(`  ${blue('codex-flow session save mywork')}      # Save session`);
        console.log(`  ${blue('codex-flow session restore abc123')}   # Restore session`);
        console.log(`  ${blue('codex-flow session validate --fix')}   # Validate and fix`);
      } else {
        ...
        console.log(`  ${blue('codex-flow help <command>')}`);
        console.log();
        console.log('Enhanced features:');
  ...
  console.log();
  console.log('For detailed help on enhanced commands: codex-flow help <command>');
...
- \`npx codex-flow start\`: Start the orchestration system
- \`npx codex-flow --help\`: Show all available commands
...
- Use \`npx codex-flow status\` to check system health
- Monitor with \`npx codex-flow monitor\` for real-time updates
...
- Query with \`npx codex-flow memory query <search>\`
...
## Commands
- \`npx codex-flow memory query <search>\`: Search stored information
- \`npx codex-flow memory stats\`: Show memory usage statistics
- \`npx codex-flow memory export <file>\`: Export memory to file
- \`npx codex-flow memory import <file>\`: Import memory from file

## Configuration
Memory settings are configured in \`codex-flow.config.json\` (legacy: `claude-flow.config.json` still accepted):
\`\`\`json
{
  "memory": {
    "backend": "json",
...
- \`npx codex-flow agent list\`: Show active agents
...
\`\`\`bash
# Agent Management
npx codex-flow agent spawn <type> --name <name> --priority <1-10>
npx codex-flow agent list
npx codex-flow agent info <agent-id>
npx codex-flow agent terminate <agent-id>

# Task Management  
npx codex-flow task create <type> <description> --priority <1-10> --deps <task-ids>
npx codex-flow task list --verbose
npx codex-flow task status <task-id>
npx codex-flow task cancel <task-id>

# System Monitoring
npx codex-flow status --verbose
npx codex-flow monitor --interval 5000
\`\`\`

## Workflow Execution
Workflows are defined in JSON format and can orchestrate complex multi-agent operations:
\`\`\`bash
npx codex-flow workflow examples/research-workflow.json
npx codex-flow workflow examples/development-config.json --async
\`\`\`
...
## Configuration
Coordination settings in \`codex-flow.config.json\` (legacy: `claude-flow.config.json` still accepted):
\`\`\`json
{
  "orchestrator": {
...
## Troubleshooting
- Check agent health with \`npx codex-flow status\`
- View detailed logs with \`npx codex-flow monitor\`
