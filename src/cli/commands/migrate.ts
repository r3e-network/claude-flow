...
export function createMigrateCommand(): Command {
  ...
  command
    .description('Migrate existing codex-flow projects to optimized prompts')
...
async function showMigrationStatus(projectPath: string): Promise<void> {
  ...
  if (!analysis.hasOptimizedPrompts) {
    console.log(chalk.bold('\n💡 Recommendations:'));
    console.log('  • Run migration analysis: codex-flow migrate analyze');
    console.log('  • Start with dry run: codex-flow migrate --dry-run');
    console.log('  • Use selective strategy: codex-flow migrate --strategy selective');
  }
