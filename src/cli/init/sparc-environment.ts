...
This CLAUDE.md file configures Claude Code to help you BUILD YOUR OWN APPLICATIONS using the codex-flow orchestration system. Claude-flow is a tool to help you develop software - it is NOT the project you should be modifying.

**IMPORTANT**: 
- Use codex-flow commands to BUILD YOUR APPLICATION
- DO NOT modify the codex-flow system itself
...
- \`./codex-flow start --ui\`: Start the AI orchestration system to help build YOUR app
- \`./codex-flow sparc "Build a [YOUR APP TYPE] application"\`: Start building YOUR application
- \`./codex-flow swarm "Create [YOUR FEATURE]"\`: Use multiple AI agents to build complex features
- \`./codex-flow status\`: Check the status of YOUR development tasks

### 🤖 AI Agents to Build Your Application
- \`./codex-flow agent spawn coder\`: Create a coding agent for YOUR project
- \`./codex-flow agent spawn researcher\`: Research best practices for YOUR features
- \`./codex-flow agent spawn tester\`: Create tests for YOUR application
- \`./codex-flow agent list\`: See agents working on YOUR project

### 📋 Managing Your Development Tasks
- \`./codex-flow task create feature "Add user authentication to my app"\`: Create development tasks
- \`./codex-flow task list\`: View YOUR project's task queue
- \`./codex-flow workflow my-app-workflow.json\`: Automate YOUR development workflow

### 🧠 Project Knowledge Management
- \`./codex-flow memory store "my_app_architecture" "REST API with React frontend"\`: Store YOUR project decisions
- \`./codex-flow memory get "my_app_requirements"\`: Retrieve YOUR project information
- \`./codex-flow memory list\`: See all stored knowledge about YOUR project
- \`./codex-flow memory export my-project-knowledge.json\`: Export YOUR project knowledge

### 🎯 SPARC Modes for Building Your Application
- \`./codex-flow sparc "Create a todo list app with React"\`: Start building YOUR app
- \`./codex-flow sparc run coder "Implement user login for my app"\`: Code YOUR features
- \`./codex-flow sparc tdd "Shopping cart functionality"\`: Build YOUR features test-first
- \`./codex-flow sparc run architect "Design my app's database schema"\`: Design YOUR architecture
...
\`./codex-flow swarm "Build a complete e-commerce website" --strategy development --parallel\`
...
./codex-flow sparc "Create a task management web app with React and Node.js"

# Add authentication to YOUR app
./codex-flow sparc run coder "Add user authentication with JWT tokens to my task app"

# Create tests for YOUR features
./codex-flow sparc tdd "Task creation and assignment features"

# Use multiple agents to build faster
./codex-flow swarm "Build complete task management system" --strategy development --parallel
\`\`\`

### 🔍 Research Phase for Your Project
\`\`\`bash
# Research best practices for YOUR app type
./codex-flow sparc run researcher "Research best practices for building SaaS applications"

# Store YOUR project's technical decisions
./codex-flow memory store "tech_stack" "React, Node.js, PostgreSQL, Redis"
./codex-flow memory store "auth_strategy" "JWT with refresh tokens"

# Analyze similar applications
./codex-flow sparc run analyzer "Analyze successful task management apps for feature ideas"
\`\`\`

### 🏗️ Development Workflow for Your Application
\`\`\`bash
# Design YOUR application architecture
./codex-flow sparc run architect "Design microservices architecture for my e-commerce platform"

# Implement YOUR features with TDD
./codex-flow sparc tdd "Shopping cart with discount calculation"

# Multiple agents working on YOUR project
./codex-flow swarm "Build user dashboard with analytics" --strategy development --max-agents 5

# Review and optimize YOUR code
./codex-flow sparc run reviewer "Review authentication implementation for security"
\`\`\`

### 🔧 Testing and Debugging Your Application
\`\`\`bash
# Comprehensive testing for YOUR app
./codex-flow sparc run tester "Create comprehensive test suite for my API endpoints"

# Debug issues in YOUR application
./codex-flow sparc run debugger "Debug why user login is failing in production"

# Performance optimization for YOUR app
./codex-flow sparc run optimizer "Optimize database queries in my application"

# Security review for YOUR project
./codex-flow sparc run reviewer "Security audit of my payment processing system"
\`\`\`

### 📚 Documentation for Your Project
\`\`\`bash
# Generate documentation for YOUR API
./codex-flow sparc run documenter "Create API documentation for my REST endpoints"

# Document YOUR project architecture
./codex-flow sparc run documenter "Document the system architecture and design decisions"

# Create user guides for YOUR application
./codex-flow sparc run documenter "Write user guide for the admin dashboard"
\`\`\`
...
./codex-flow memory store "app_type" "SaaS project management tool"
./codex-flow memory store "target_users" "Small to medium development teams"
./codex-flow memory store "core_features" "Task tracking, team collaboration, time tracking, reporting"

# Design YOUR architecture based on requirements
./codex-flow sparc run architect "Design scalable SaaS architecture for project management tool"

# Research best practices for YOUR app type
./codex-flow sparc run researcher "Research best practices for multi-tenant SaaS applications"
\`\`\`
...
./codex-flow sparc tdd "User registration and team creation"
./codex-flow sparc run coder "Implement project and task management features"

# Phase 2: Advanced features
./codex-flow swarm "Build real-time collaboration features" --strategy development --parallel
./codex-flow sparc run coder "Add time tracking and reporting dashboard"

# Phase 3: Polish and optimize
./codex-flow sparc run optimizer "Optimize performance for 1000+ concurrent users"
./codex-flow sparc run designer "Improve UI/UX for mobile responsiveness"
\`\`\`
...
./codex-flow sparc run tester "Complete end-to-end testing suite"
./codex-flow sparc run reviewer "Final security audit before launch"

# Documentation for YOUR users
./codex-flow sparc run documenter "Create user documentation and API guides"

# Performance optimization
./codex-flow sparc run optimizer "Optimize for production deployment"
\`\`\`

## 🛠️ How Claude Code Helps Build YOUR Application

### 🤖 AI-Powered Development Assistance
When you use codex-flow commands, Claude Code will help you:
- **Write code** for YOUR application (not for codex-flow itself)
...
./codex-flow swarm "Build complete e-commerce platform with payment integration" \\
  --strategy development --parallel --max-agents 8

# Example: Adding real-time features to YOUR app
./codex-flow swarm "Add real-time chat and notifications to my app" \\
  --strategy development --parallel --max-agents 5

# Example: Comprehensive testing of YOUR application
./codex-flow swarm "Create comprehensive test suite for my API" \\
...
- Modifying the codex-flow system itself
- Changing how codex-flow works internally
- Updating codex-flow commands or features
- Fixing codex-flow bugs (report them on GitHub instead)
...
\`\`\`bash
./codex-flow sparc "Create a [YOUR APP TYPE] application with [YOUR MAIN FEATURES]"
\`\`\`
