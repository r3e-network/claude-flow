...
export async function initCommand(options: InitOptions = {}) {
  try {
    ...
    console.log('\n   Next steps:');
    console.log('   1. Run "codex-flow swarm --help" to see swarm options');
    ...
    console.log('   4. Run "codex-flow help" for all available commands');

    if (options.sparc) {
      console.log('   5. Run "codex-flow sparc modes" to see available SPARC modes');
