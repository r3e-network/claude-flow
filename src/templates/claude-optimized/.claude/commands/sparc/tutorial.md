...
1. Run directly: `npx codex-flow sparc run tutorial "your task"`
...
npx codex-flow sparc run tutorial "create full SPARC onboarding course with batch examples"

# Build mode-specific tutorials simultaneously
npx codex-flow sparc run tutorial "generate tutorials for all SPARC modes in parallel"

# Create interactive workshop materials
npx codex-flow sparc run tutorial "build hands-on SPARC workshop with concurrent exercises"
```
