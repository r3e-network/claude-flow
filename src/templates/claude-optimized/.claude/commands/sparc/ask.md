...
1. Run directly: `npx codex-flow sparc run ask "your task"`
...
npx codex-flow sparc run ask "how should I implement user authentication with testing?"

# Decompose complex project into SPARC tasks
npx codex-flow sparc run ask "help me plan a full e-commerce platform build"

# Find best mode for specific problem
npx codex-flow sparc run ask "which mode should I use for database schema refactoring?"
```
