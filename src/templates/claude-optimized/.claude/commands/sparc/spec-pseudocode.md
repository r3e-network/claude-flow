...
1. Run directly: `npx codex-flow sparc run spec-pseudocode "your task"`
...
npx codex-flow sparc run spec-pseudocode "create full system specification using parallel codebase analysis"

# Build API specifications with concurrent pattern matching
npx codex-flow sparc run spec-pseudocode "generate REST API specs with batch endpoint analysis"

# Create data model specifications with parallel schema extraction
npx codex-flow sparc run spec-pseudocode "document database architecture using concurrent model analysis"
```
