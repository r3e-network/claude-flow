...
npx codex-flow test:integration:auth & \
npx codex-flow test:integration:data & \
npx codex-flow test:integration:storage & \
wait
```
...
1. Run directly: `npx codex-flow sparc run mcp-optimized "your task"`
...
npx codex-flow sparc run mcp-optimized "integrate auth, payment, and notification services"

# Batch API configuration
npx codex-flow sparc run mcp-optimized "configure all external service endpoints"
```
