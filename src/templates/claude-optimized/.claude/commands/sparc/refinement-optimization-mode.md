...
1. Run directly: `npx codex-flow sparc run refinement-optimization-mode-optimized "your task"`
...
npx codex-flow sparc run refinement-optimization-mode-optimized "optimize all modules"

# Batch refactor large files
npx codex-flow sparc run refinement-optimization-mode-optimized "break down all files over 500 lines"
```
