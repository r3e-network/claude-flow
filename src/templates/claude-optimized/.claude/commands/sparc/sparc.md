...
1. Run directly: `npx codex-flow sparc run sparc-optimized "your complex task"`
...
npx codex-flow sparc run sparc-optimized "implement complete e-commerce platform"

# Parallel multi-service implementation
npx codex-flow sparc run sparc-optimized "create microservices architecture with 5 services"
```
