...
npx codex-flow sparc batch-run --modes '{
...
npx codex-flow sparc pipeline --stages '[
...
npx codex-flow sparc batch-tdd --features '{
...
npx codex-flow sparc batch-analyze --components '{
...
npx codex-flow sparc batch-spec --components '[
...
npx codex-flow sparc batch-pseudocode --algorithms '{
...
npx codex-flow sparc distributed-architect --services '[
...
npx codex-flow sparc parallel-tdd --config '{
  "modules": {
...
npx codex-flow sparc batch-integrate --components '[
...
npx codex-flow sparc batch-memory-store --data '{
...
npx codex-flow sparc batch-memory-query --queries '[
...
npx codex-flow sparc swarm-batch --project "enterprise-app" --config '{
  "phases": [
    {
      "name": "design",
...
npx codex-flow sparc distribute --analysis '{
...
npx codex-flow sparc cache-config --settings '{
...
npx codex-flow sparc enterprise-flow --project "fintech-platform" --parallel-config '{
  "specification": {
...
npx codex-flow sparc migrate-batch --from "monolith" --to "microservices" --strategy '{
...
npx codex-flow sparc ml-pipeline --config '{
  "data-pipeline": {
...
npx codex-flow sparc monitor-batch --dashboards '[
...
npx codex-flow sparc analyze-performance --metrics '{
