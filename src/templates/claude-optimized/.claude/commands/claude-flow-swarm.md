...
npx codex-flow swarm "your complex task" --strategy <type> [options]

# Batch swarm operations
npx codex-flow swarm batch --tasks "frontend:dev,backend:dev,database:architect" --parallel
```
...
npx codex-flow swarm multi-strategy --config '{
...
npx codex-flow swarm batch-dev --services '{
...
npx codex-flow swarm batch-research --topics '{
...
npx codex-flow swarm batch-test --suites '{
...
npx codex-flow swarm pipeline --config '{
  "stages": [
...
npx codex-flow swarm analyze-pipeline --stages '{
...
npx codex-flow swarm deploy-multi --regions '{
...
npx codex-flow swarm federated-train --nodes 20 --parallel --aggregate-method "secure"
```
...
npx codex-flow swarm monitor-batch --metrics '{
...
npx codex-flow swarm auto-manage --rules '{
...
npx codex-flow swarm distribute --algorithm "weighted" --factors '{
  "agent-capacity": 0.4,
  "task-complexity": 0.3,
  "priority": 0.3
}'
...
npx codex-flow swarm batch-execute --resilient '{
...
npx codex-flow swarm batch --cache '{
...
npx codex-flow swarm optimize-network --compression "gzip" --batching 100 --keepalive
```
...
npx codex-flow swarm full-stack --project "e-commerce" --parallel-components '{
...
npx codex-flow swarm data-pipeline --config '{
...
npx codex-flow swarm security-audit --parallel-scans '{
