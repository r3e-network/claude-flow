...
codex-flow task create development "Implement user authentication system" \\
  --priority 80 \\
...
codex-flow task status task-789 \\
  --show-logs \\
  --show-checkpoints \\
  --show-metrics \\
  --show-dependencies \\
...
codex-flow task cancel task-789 \\
...
codex-flow task workflow create "E-commerce Platform" \\
  --description "Complete e-commerce development workflow" \\
  --max-concurrent 8 \\
  --strategy priority-based \\
  --error-handling continue-on-error

codex-flow task workflow execute workflow-123 \\
  --variables '{"environment":"staging","version":"2.1.0"}' \\
  --monitor

codex-flow task workflow visualize workflow-123 \\
  --format dot \\
